...
from src.query.budget import BudgetGuard, resolve_max_cost_usd, resolve_max_turns
...
def test_resolve_max_cost_usd_precedence() -> None:
    assert resolve_max_cost_usd(1.25, 9.0) == 1.25
    assert resolve_max_cost_usd(None, 9.0) == 9.0
    assert resolve_max_cost_usd(None, 0.0) == 0.0
    assert resolve_max_cost_usd(0.0, 9.0) == 0.0
