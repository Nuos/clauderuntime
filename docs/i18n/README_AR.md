...
![مثال على الجلسة](../assets/readme/claw-codex-tool-skill-json.png)
...
- **[SETUP_GUIDE.md](../guides/SETUP_GUIDE.md)** — التثبيت المفصل
- **[CONTRIBUTING.md](../../CONTRIBUTING.md)** — دليل التطوير
- **[TESTING.md](../guides/TESTING.md)** — دليل الاختبار
