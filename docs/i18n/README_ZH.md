...
![ClawCodex 截图](../assets/readme/clawcodex-screenshot-1.png)
...
📚 更早的条目已移至完整的 **[News 归档](../history/NEWS.md)**。
...
![SWE-bench Verified —— clawcodex vs openclaude on Gemini 2.5 Pro](../assets/readme/swebench-verified-gemini.png)
...
| 文档    | ✅ 完成   | 指南、多语言 README、[当前状态](../status/current.md) |
...
**详细功能状态请查看 [当前状态](../status/current.md) 与 [Backlog 索引](../status/backlog.md)。**
...
**[`examples/`](../../examples/) 目录下的每个应用都由 ClawCodex 自身端到端生成** —— 用的正是你刚安装的这个 CLI、同一个 agent loop、同一套工具。零人工修改 🙂

| 演示 | 技术栈 | 描述 |
| ---- | ----- | ----------- |
| [`examples/crm-app`](../../examples/crm-app) | React 18 + Vite + Vitest | 迷你 CRM：联系人、商机、仪表盘与完整测试套件 |
| [`examples/linkedin-app`](../../examples/linkedin-app) | React 18 + Vite + React Router | LinkedIn 风格信息流：个人主页、人脉、职位、私信 |
| [`examples/minecraft-app`](../../examples/minecraft-app) | React + three.js + @react-three/fiber | 浏览器体素沙盒：地形、挖掘、HUD 与玩家控制 |
| [`examples/wc26-intro`](../../examples/wc26-intro) | 纯静态 HTML/CSS/JS | 2026 世界杯介绍页——动效首屏、实时倒计时、主办国、16 座球场、赛制与破纪录数据；用全新的 Z.ai **GLM-5.2** 模型端到端生成 |

```bash
cd examples/crm-app   # 或 linkedin-app / minecraft-app
npm install
npm run dev        # vite 开发服务器
```

`examples/wc26-intro` 是单文件静态页面——直接在浏览器中打开 [`examples/wc26-intro/index.html`](../../examples/wc26-intro/index.html) 即可。
...
关于 Reference-7 核心组件，以及从用户输入到模型输出的黄金路径，请见
[`docs/architecture/overview.md`](../architecture/overview.md)。推荐新贡献者从这里入手。

Claude Code 参考研究资料位于 [`docs/reference/claude-code/`](../reference/claude-code/)；当前开发计划位于
...
├── docs/status/            # 当前状态与高层 backlog
├── docs/archive/           # 历史能力矩阵、旧 TODO 与归档资料
...
- **[SETUP_GUIDE.md](../guides/SETUP_GUIDE.md)** —— 详细安装说明
- **[CONTRIBUTING.md](../../CONTRIBUTING.md)** —— 开发指南
- **[TESTING.md](../guides/TESTING.md)** —— 测试指南
- **[CHANGELOG.md](../../CHANGELOG.md)** —— 版本历史
- **[backlog.md](../status/backlog.md)** —— 当前高层差距索引；可执行工作项以 GitHub Issues 为准
