...
|:---:|
| ![Bash Execution](../assets/readme/claw-codex-bash.png) |
| *Real-time Tool Execution* |
| ![Web Fetch](../assets/readme/claude-code-webfetch.png) |
| *Instant Web Content Extraction* |
| ![File Operations](../assets/readme/claw-codex-write-read.png) |
| *Seamless Coding & Debugging* |
| ![Skills (Slash Commands)](../assets/readme/claw-codex-skill.png) |
...
![Exemple de session](../assets/readme/claw-codex-tool-skill-json.png)
...
- **[SETUP_GUIDE.md](../guides/SETUP_GUIDE.md)** — Installation détaillée
- **[CONTRIBUTING.md](../../CONTRIBUTING.md)** — Guide de développement
- **[TESTING.md](../guides/TESTING.md)** — Guide de test
